...
public class LocksmithService extends IntentService {
    ...
    private static final String ACTION_FOO = "uk.co.platosys.fingerprinter.action.FOO";
    private static final String ACTION_BAZ = "uk.co.platosys.fingerprinter.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "uk.co.platosys.fingerprinter.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "uk.co.platosys.fingerprinter.extra.PARAM2";
